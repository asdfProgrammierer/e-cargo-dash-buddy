...
import { MapPinned, Warehouse, Route as RouteIcon, Mail, PackageSearch, Truck, KeyRound, PackageCheck } from "lucide-react";
...
const tabs = [
  ...
  { to: "/admin/einstellungen/uebergabe", label: "Übergabe-Modi", icon: PackageCheck },
